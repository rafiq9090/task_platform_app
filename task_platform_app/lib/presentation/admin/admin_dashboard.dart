                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      children: [
                        _buildStatCard(
                          'Total Projects',
                          adminProvider.stats?.summary.totalProjects
                                  .toString() ??
                              '0',
                          Icons.folder,
                          Colors.blue,
                        ...
                        _buildStatCard(
                          'Completed',
                          adminProvider.stats?.summary.completedTasks
                                  .toString() ??
                              '0',
                          Icons.done_all,
                          Colors.green,
                        ...
                        _buildStatCard(
                          'Pending Pay',
                          adminProvider.stats?.summary.pendingPayments
                                  .toString() ??
                              '0',
                          Icons.payment,
                          Colors.red,
                      ...
                      children: [
                        Expanded(
                          child: _buildSimpleCard(
                            'Buyers',
                            adminProvider.stats?.users.totalBuyers.toString() ??
                                '0',
                          ),
                        ),
                        ...
                        Expanded(
                          child: _buildSimpleCard(
                            'Developers',
                            adminProvider.stats?.users.totalDevelopers
                                    .toString() ??
                                '0',
                          ),
                        ),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            _buildFinancialRow(
              'Total Received',
              format.format(stats?.totalPaymentsReceived ?? 0),
              Colors.green,
            ),
            const Divider(color: Colors.white24, height: 32),
            _buildFinancialRow(
              'Platform Revenue',
              format.format(stats?.totalRevenue ?? 0),
              Colors.white,
            ),
